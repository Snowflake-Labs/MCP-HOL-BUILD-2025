...
tools:
  - name: "pubmed_search"
    ...
    description: "A tool that performs keyword and vector search over free full-text archive of biomedical and life sciences journal articles in the U.S. National Institutes of Health's National Library of Medicine (NIH/NLM). For best results, include the 'columns' parameter specifying which fields to return, such as 'title', 'abstract', 'brief_description', and 'disease_stage'."
    title: "PubMed"
  - name: "clinical_trials_search"
    identifier: "CLINICAL_TRIALS_RESEARCH_DATABASE.CT.CLINICAL_TRIALS_SEARCH_SERVICE"
    type: "CORTEX_SEARCH_SERVICE_QUERY"
    description: "A tool that performs keyword and vector search over clinical trials data to support strategic decisions across the drug development lifecycle, from early-stage research and protocol design to regulatory submissions and market access strategies. For best results, include the 'columns' parameter specifying which fields to return, such as 'title', 'abstract', 'brief_description', and 'disease_stage'."
